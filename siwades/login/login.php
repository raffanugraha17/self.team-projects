		...
		public function logout(){
			...
			if ($_GET['menu'] == 404) {
	            ...
	            if ($res) {
		            ...
		            header('location:index.php');
					echo "
					<script>console.log('error login.php if dalam if')</script>
					";
	            }else{
	            	$res = $_mysqli->query("ROLLBACK");
	            	var_dump($res);
					echo "
					<script>console.log('error login.php else dalam if')</script>
					";
	            }
				echo "
				<script>console.log('error login.php if 1')</script>
				";
        	}
			echo "
			<script>console.log('error login.php')</script>
			";
		}
	}
 ?>